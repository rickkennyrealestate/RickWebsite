      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0">
          <img
            ...
            alt="Brazos Valley home at dusk"
            className="h-full w-full object-cover"
          />
          <div className="absolute inset-0 bg-gradient-to-r from-foreground/85 via-foreground/70 to-foreground/40" />
        </div>

        <div className="container relative flex min-h-[560px] flex-col justify-center py-24 md:min-h-[640px]">
        ...
        <div className="container grid grid-cols-1 items-center gap-12 lg:grid-cols-5">
          <div className="lg:col-span-2">
            <div className="relative mx-auto max-w-sm">
              ...
              <img
                src="/assets/images/rick-headshot.jpg"
